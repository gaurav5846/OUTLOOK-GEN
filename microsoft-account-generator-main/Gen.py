...
def intro():
    ...
    os.system('color 4')
    os.system('color')
    print("Discord: Undefined User#5545")
    print('')
...
def create():
    ...
    driver.find_element(by = By.ID , value = "Country").send_keys(["India"])
    ...
    try:
        ...
        print("Ip flagged , couldnt load captcha ...[Change Ip using vpn Recommended vpn - Nord VPN ")
        driver.quit()
        exit(0)
    os.system('cls')
